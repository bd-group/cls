...
public class BlockScheduleRealtimeUpdate implements BlockScheduleInterface{
    ...
    public BlockScheduleRealtimeUpdate(ScheduleFactory.stdBlockAlgorithm algorithm) throws Exception {
	this();
	Algorithm = (BlockAlgorithmInterface) ScheduleFactory.stdBlockAlgorithmMap.get(algorithm).newInstance();
    }

    public BlockScheduleRealtimeUpdate(BlockAlgorithmInterface algrithm) throws Exception {
	this();
	Algorithm = algrithm;
    }
